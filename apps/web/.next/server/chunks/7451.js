"use strict";exports.id=7451,exports.ids=[7451],exports.modules={37451:(e,t,o)=>{o.r(t),o.d(t,{AppKitModal:()=>ep,W3mListWallet:()=>eg,W3mModal:()=>ed,W3mModalBase:()=>ec,W3mRouterContainer:()=>ev,W3mUsageExceededView:()=>eh});var r=o(16062),i=o(60714),a=o(71122),n=o(11976),s=o(29543),l=o(99039),c=o(63324),d=o(57425),p=o(49475),u=o(21593),h=o(25715);let m={isUnsupportedChainView:()=>"UnsupportedChain"===p.RouterController.state.view||"SwitchNetwork"===p.RouterController.state.view&&p.RouterController.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView()||await h.w.isSIWXCloseDisabled()){s.I.shake();return}("DataCapture"===p.RouterController.state.view||"DataCaptureOtpConfirm"===p.RouterController.state.view)&&u.ConnectionController.disconnect(),s.I.close()}};var w=o(72615),b=o(45084),g=o(52967),y=o(98191),f=o(6056),v=o(63106),x=o(83482);let k=(0,x.iv)`
  :host {
    display: block;
...
`;var D=function(e,t,o,r){var i,a=arguments.length,n=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(n=(a<3?i(n):a>3?i(t,o,n):i(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};let j={lg:"lg-regular",md:"md-regular",sm:"sm-regular"},L={lg:"lg",md:"md",sm:"sm"},H=class extends r.oi{constructor(){super(...arguments),this.imageSrc="",this.text="",this.size="lg",this.type="text-dropdown",this.disabled=!1}render(){return(0,r.dy)`<button ?disabled=${this.disabled} data-size=${this.size} data-type=${this.type}>
    ...
    </wui-flex>`}};H.styles=[f.ET,f.ZM,B],D([(0,i.Cb)()],H.prototype,"imageSrc",void 0),D([(0,i.Cb)()],H.prototype,"text",void 0),D([(0,i.Cb)()],H.prototype,"size",void 0),D([(0,i.Cb)()],H.prototype,"type",void 0),D([(0,i.Cb)({type:Boolean})],H.prototype,"disabled",void 0),H=D([(0,v.M)("wui-select")],H),o(55430),o(20167);var V=o(25e3),F=o(54211);let M=(0,y.iv)`
  wui-image {
